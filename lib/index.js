...
function (_super) {
  ...
  function VueIframe(props) {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              this.parcel.mountPromise.then(function () {// debugger
    ...
    _this.internalCSSsandbox = function (originAppendChild, codeIsExecuting) {
    ...
    _this.vueWrapper1.appendChild(_this.vueWrapper2); // 临时保存appendChild


    var originAppendChild = HTMLHeadElement.prototype.appendChild;
    _this.internalCSSsandbox = _this.internalCSSsandbox.bind(_this, originAppendChild);
    return _this;
  }
