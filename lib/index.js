  ...
  function VueIframe(props) {
    ...
    _this.componentDidUpdate = function () {
      ...
      if (!(visible === _this.visible)) {
        ...
        if (!visible) {
          if ((_a = rootNodeWrapper) === null || _a === void 0 ? void 0 : _a.contains(_this.vueWrapper1)) {
            _this.vueWrapper1 = (_b = rootNodeWrapper) === null || _b === void 0 ? void 0 : _b.removeChild(_this.vueWrapper1);
          } else {
            console.warn('无法卸载该组件, 发生错误的原因可能是没有加载到该组件');
          }
        } else {
          (_c = rootNodeWrapper) === null || _c === void 0 ? void 0 : _c.appendChild(_this.vueWrapper1);
        }
      }
      ...
      if (!equal(extraProps, _this.extraProps)) {
        ...
        _this.parcel.update(extraProps);
      }
    };
    /**
    ...
    _this.componentWillUnmount = function () {
      ...
      if ((_a = _this.rootNodeWrapper.current) === null || _a === void 0 ? void 0 : _a.contains(_this.vueWrapper1)) {
    ...
    _this.registerComponentAndMount = function (component) {
      var lifecycles = _this.registerComponent(_this.vueWrapper2, component, _this.currentName);
      ...
      if (_this.loadType === 'script') {
        return new Promise(function (res) {
          ...
          window.require = function (str) {
            return str === 'vue' && _this.framework;
          };
